    ...
    return ( 
        ...
        <div className="mx-40 mt-20 mb-32 flex justify-between">
            ...
            <div className="flex flex-col gap-10 justify-between items-end">
                <button onClick={toggleShortlisted} className= {`flex py-2 px-6 rounded-lg ${users.shortlisted ? 'bg-light-blue/20' : 'bg-lime'} `}>
                ...
                <div className="text-grey">
                    ...
                    <div>
                        <p className="text-xl text-right">Project Status</p>
                        {
                            ...
                            :
                            <p className="text-4xl flex text-red"><img className="pr-4" src={error} alt="" />Not Submitted</p>
                        }
                    </div>
                    <div className="text-grey flex flex-col items-end">
                        ...
                        <div className="flex gap-6 items-center">
                            ...
                            {
                                users.hackerrank ?
                                <a target="_blank" href={users.hackerrank}><img src={hackerrank} alt="" /></a> : null
                            }
                            {
                                users.linkedin ?
                                <a target="_blank" href={users.linkedin}><img src={linkedin} alt="" /></a> : null
                            }
                            {
                                users.dribble ?
                                <a target="_blank" href={users.dribble}><img src={dribbble} alt="" /></a> : null
                            }
                            {
                                users.behance ?
                                <a target="_blank" href={users.behance}><img src={behance} alt="" /></a> : null
                            }
                            {
                                users.custom ?
                                <a target="_blank" href={users.custom}><img src={custom} alt="" /></a> : null
                            }
                        </div>
                    </div>
                </div>
