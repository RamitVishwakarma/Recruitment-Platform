...
<<<<<<< HEAD
        ...
        <h2 className="mt-16 mx-60 font-bold text-purple text-4xl">
          Submissions
        </h2>
=======
              <div className="">
        ...
        <div className="flex items-center mx-60 justify-between">
          <div className="grid grid-cols-3 grid-rows-2 gap-3 bg-text-box py-7 px-4 rounded-xl w-fit">
            <div className="flex w-60 gap-4 items-center">
              ...
              {users.links.github ? (
                <a
                  className="overflow-hidden w-60 underline text-grey text-xl line-clamp-1 text-ellipsis"
                  href={users.links.github}>
                  {users.links.github}
                </a>
              ) : (
                <p className="text-grey/50 text-xl">Not submitted</p>
              )}
            </div>
