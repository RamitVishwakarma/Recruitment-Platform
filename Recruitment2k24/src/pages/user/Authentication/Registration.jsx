        ...
        <div className="h-full relative z-10 w-full md:w-10/12 overflow-hidden mx-auto py-8 rounded-3xl mb-16">
          ...
          <form
            ...
            <div className="flex max-lg:flex-col-reverse gap-4 justify-center items-center my-10">
              ...
              <button
                type="submit"
                className="sm:px-20 px-10 w-11/12 md:w-fit max-w-56 py-3 text-grey font-bold text-2xl rounded-lg bg-lime hover:bg-button-hover shadow-lg flex items-center justify-center">
                <span>Register</span>
              </button>
            </div>
          </form>
