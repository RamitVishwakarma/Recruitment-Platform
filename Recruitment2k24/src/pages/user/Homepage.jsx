      ...
      <div className="flex flex-col gap-20 items-center mb-20 text-grey">
        ...
        <div className="cards">
          <div className="row1">
            ...
            <div className="card bg-red/20 text-red font-bold">
              <img src={WebClub} alt="" />
              <h2>Web Club</h2>
              <p>Creating wonders in web apps, encompassing both front-end and back-end development to ensure a seamless online user experience.</p>
              <span>02</span>
            </div>
        ...
        <div className="flex items-end gap-8">
          <div className="flex">
            ...
            <img className="absolute mt-2 -translate-x-2" src={Pointer} alt="" />
          </div>
