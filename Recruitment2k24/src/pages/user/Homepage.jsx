...
import ArrowRight from "../../../src/assets/arrow_circle_right.svg"
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-20 items-center mb-20 text-grey">
        ...
        <div className="cards">
          <div className="row1">
            <div className="card bg-purple/20">
              <img src={Programming} alt="" />
              <h2 className="text-purple">Programming</h2>
              <p>The art of instructing computers through code to perform specific tasks, solve problems, and create software applications.</p>
              <span className="text-purple">01</span>
            </div>
            <div className="card bg-red/20">
              <img src={WebClub} alt="" />
              <h2 className="text-red">Web Club</h2>
              <p> The practice of creating and maintaining websites and web applications, encompassing both front-end and back-end development to ensure a seamless online user experience.</p>
              <span className="text-red">02</span>
            </div>
            <div className="card bg-lime/20">
              <img src={Android} alt="" />
              <h2 className="text-lime">Android</h2>
              <p>The domain focused on developing applications and systems for the Android operating system, powering a vast majority of mobile devices.</p>
              <span className="text-lime">03</span>
            </div>
          </div>

          <div className="row2">
            <div className="card bg-light-blue/20">
              <img src={Design} alt="" />
              <h2 className="text-light-blue">Design</h2>
              <p>The creative process of shaping the visual and user interface aspects of digital products, including websites, apps to enhance user engagement and satisfaction.</p>
              <span className="text-light-blue">04</span>
            </div>
            <div className="card bg-[#D2BD0026]">
              <img src={ML} alt="" />
              <h2 className="text-[#ECCD2A]">Machine<br />Learning</h2>
              <p>Harnessing algorithms to enable computers to learn from data, recognize patterns, and make predictions autonomously.</p>
              <span className="text-[#ECCD2A]">05</span>
            </div>
          </div>
        </div>
        ...
        {/* ready? */}
        <div className="mt-10">
          <p className="text-6xl w-3/5 mx-auto text-center">Ready to be a part of a thriving community of geeks?</p>
        </div>
        {/* timeline */}
        <div className="flex items-end gap-8">
          <div className="flex">
            <img src={Timeline} alt="" />
            <img className="absolute mt-2" src={Pointer} alt="" />
          </div>
          <div className="flex gap-14 text-4xl flex-col pr-8">
            <div className="flex gap-14 justify-between">
              <h3>Registrations Start</h3>
              <h3 className="font-bold date"><span className="text-light-blue">20</span> <span className="text-purple">Feb</span> <span className="text-red">2024</span></h3>
            </div>
            <div className="flex gap-14 justify-between">
              <h3>Projct Submissions</h3>
              <h3 className="font-bold date"><span className="text-light-blue">27</span> <span className="text-purple">Feb</span> <span className="text-red">2024</span></h3>
            </div>
            <div className="flex gap-14 justify-between">
              <h3>Quiz Round</h3>
              <h3 className="font-bold date"><span className="text-light-blue">03</span> <span className="text-purple">Mar</span> <span className="text-red">2024</span></h3>
            </div>
            <div className="flex gap-14 justify-between">
              <h3>Interview Shortlisting</h3>
              <h3 className="font-bold date"><span className="text-light-blue">05</span> <span className="text-purple">Mar</span> <span className="text-red">2024</span></h3>
            </div>
            <div className="flex gap-14 justify-between">
              <h3>Results</h3>
              <h3 className="font-bold date"><span className="text-light-blue">10</span> <span className="text-purple">Mar</span> <span className="text-red">2024</span></h3>
            </div>
          </div>
        </div>
